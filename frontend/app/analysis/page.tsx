		...
		<div className='min-h-screen bg-secondary'>
			...
			<main className='lg:pl-64 pt-16 lg:pt-0 pb-6'>
				<div className='p-4 sm:p-6 lg:p-8 max-w-6xl mx-auto space-y-6'>
					...
					{!hasRealAnalysis || !effectiveAnalysis ? (
						<motion.div initial='hidden' animate='visible' variants={fadeIn}>
							<Card hover={false} className='text-center py-12'>
								<Brain className='w-10 h-10 text-text-secondary mx-auto mb-3' />
								<p className='text-text-primary font-semibold'>Tahlil uchun ma&apos;lumot yetarli emas</p>
								<p className='text-sm text-text-secondary mt-1'>Bir nechta klinik holatni yakunlang — kuchli va zaif tomonlaringiz tahlil qilinadi.</p>
								<Link href='/cases' className='mt-4 inline-flex items-center gap-1.5 px-4 py-2 rounded-xl bg-primary text-secondary text-sm font-semibold'>
									<BookOpen className='w-4 h-4' /> Klinik holatlarga o&apos;tish
								</Link>
							</Card>
						</motion.div>
					) : (
